...
<head>
    ...
    <title>@yield('title', 'CROPSENSE AI • Technician Dashboard')</title>
    ...
    <div class="content-area">
            ...
            <ul class="navbar-nav ms-auto d-flex align-items-center gap-3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-3" style="width: 280px;">
                        ...
                        <a class="dropdown-item py-2 text-white" href="#" onclick="showProfilePanel(0)"><i class="fas fa-user me-3 text-info"></i>Profile Details</a>
                        <a class="dropdown-item py-2 text-white" href="#" onclick="showProfilePanel(1)"><i class="fas fa-cog me-3 text-primary"></i>Account Settings</a>
                        <hr class="border-secondary">
        ...
        <div id="floatingPanel" class="floating-panel">
            ...
            <ul class="nav nav-pills nav-fill bg-dark border border-secondary rounded-3 p-1 mb-4" id="profileTabs">
                <li class="nav-item"><a class="nav-link active bg-info text-dark fw-bold" onclick="switchTab(0)" style="cursor:pointer">Profile</a></li>
