    ...
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="fw-bold text-white">
                <i class="fas fa-bullhorn text-info me-3"></i> Announcements
            </h2>
            <p class="text-secondary">Official updates and alerts for Technicians</p>
        </div>
    </div>
        ...
        @if($announcements->isEmpty())
            <div class="col-12">
                <div class="card bg-dark border-secondary text-center py-5">
                    ...
                    <p class="text-muted">Important messages from the admin will appear here.</p>
                </div>
            </div>
        @else
